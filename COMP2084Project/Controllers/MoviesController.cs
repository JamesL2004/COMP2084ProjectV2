...
namespace COMP2084Project.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Movies.Include(m => m.ScreenGenre);
        ...
        public async Task<IActionResult> Create([Bind("MovieId,Title,Director,Screenwriter,ScreenGenreId,rating,review")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieId,Title,Director,Screenwriter,ScreenGenreId,rating,review")] Movie movie)
        {
            if (id != movie.MovieId)
            {
                return NotFound();
