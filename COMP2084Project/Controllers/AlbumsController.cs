...
namespace COMP2084Project.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Albums.Include(a => a.AudioGenre);
        ...
        public async Task<IActionResult> Create([Bind("AlbumId,Title,ArtistName,AudioGenreId,rating,review")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlbumId,Title,ArtistName,AudioGenreId,rating,review")] Album album)
        {
            if (id != album.AlbumId)
            {
                return NotFound();
